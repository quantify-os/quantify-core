...
Quantify provides an analysis framework in the form of a :class:`~BaseAnalysis` class and several subclasses for simple cases (:class:`~Basic1DAnalysis`, :class:`~Basic2DAnalysis`, :class:`~ResonatorSpectroscopyAnalysis`). The framework provides a structured, yet flexible, flow of the analysis steps. We encourage all users to adopt the framework by sub-classing the :class:`~BaseAnalysis`.
...
~~~~~~~~~~~~~~~~~~~~~~
    ...
    Plotting the data and saving the plots for simple 1D case can be achieve in a few lines:
